...
from .models import ToDoItem, Note, Task
...
class TaskForm(forms.ModelForm):
    title = forms.CharField(label="", widget=forms.TextInput(attrs={'class': 'form-control',
                                                                    ...
                                                                    'name': 'titleText',
                                                                    'id': 'titleText',
                                                                    'onInput': 'countTitleText()'
                                                                    }))
    description = forms.CharField(label="", widget=forms.Textarea(attrs={'class': 'form-control',
